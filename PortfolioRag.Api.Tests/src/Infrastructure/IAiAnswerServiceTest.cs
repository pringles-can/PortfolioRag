...
[TestSubject(typeof(IAiAnswerService))]
public class IAiAnswerServiceTest
{
    private readonly Mock<IAiAnswerService> _aiAnswerServiceMock;

    public IAiAnswerServiceTest()
    {
        _aiAnswerServiceMock = new Mock<IAiAnswerService>();
    }
